...
const STOP = new Set([
  'find', 'show', 'me', 'something', 'some', 'a', 'an', 'the', 'to', 'do', 'for', 'of', 'in', 'on', 'at', 'with',
  'who', 'that', 'is', 'are', 'interesting', 'good', 'best', 'nearby', 'near', 'suitable', 'people', 'person',
  'looking', 'i', 'want', 'what', 'can', 'tonight', 'today', 'tomorrow', 'weekend', 'this', 'next', 'week',
  'communities', 'community', 'groups', 'group', 'events', 'event', 'restaurants', 'restaurant', 'places', 'place',
  'creators', 'creator', 'products', 'product', 'teach', 'teaches', 'about', 'on', 'and', 'or', 'go', 'things',
]);
